 ...
 * load more designs
 */
function moreDesignCall() {
  $("#more-loader").css("display", "inherit");
  moreDesign("moreDesignCallback", "");
}

function moreDesignCallback(designs) {
  $("#more-loader").css("display", "none");
  if (designs == "done") {
    $(".more").replaceWith("<div class=\"warning\">Done.</div>");
...
/*
 * init/reinit slimbox2
 */
function slimIt() {
  $(".designs a").each(function(){
...
/*
 * to fade in loaded designs
 */
function fadeIt() {
  $(".designs img").each(function() {
    if ($(this).attr("alt") == "")
      if ($(this).complete)
        $(this).bind("load", function() { $(this).fadeIn(300); });
      else {
        $(this).load();
        $(this).bind("load", function() { $(this).fadeIn(300); });
      }
